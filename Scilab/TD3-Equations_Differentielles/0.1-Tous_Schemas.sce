...
//		y0 vecteur ligne ou réel correspondant à la situation initiale
//		t vecteur ligne de discretisation de l'intervalle [t0 à t0+T]
//		y = f(t,x) l'équation à résoudre soit forme de vecteur ligne ou réel
//		
// Retourne
//		y matrice où chaque ligne correspond à une itération correspondant à la fonction y approchée 
